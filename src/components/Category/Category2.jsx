        ...
        <div className="py-8">
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end">
                        <div  >
                          <div className="mb-4" >
                             ...
                             <p className="text-4xl xl:text-5xl font-bold opacity-40 mb-2" >Fichines</p>
                             <Button text="Navegar"
                             bgColor={"bg-primary"}
                    ...
                    <div className="py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/90 text-white rounded-3xl relative h-[320px] flex items-start">
                        <div>
                          <div className="mb-4" >
                             <p className="mb-[2px] text-white">Enjoy</p>
                             <p className="text-2xl font-semibold mb-[2px]" >With</p>
                             <p className="text-4xl xl:text-5xl font-bold opacity-40 mb-2" >Gafas VR</p>
                             <Button text="Navegar"
                             bgColor={"bg-white"}
                    ...
                    <img src={Image2} alt="" className="w-[250px] absolute -right-2 lg:top-[90px]" />
                    </div>
                    {/* third col */}
