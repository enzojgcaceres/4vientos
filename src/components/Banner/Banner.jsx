      ...
      <div className='container' >
        <div style={{ backgroundColor: data.bgColor }} className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl' >
            ...
            <div className='p-6 sm:p-8'>
                ...
                <h1 className='uppercase text-4x lg:text-7xl font-bold '> 
                {" "} 
                {data.title}
                </h1>
            ...
            <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                ...
                <p className='text-sm text-sm tracking-wide'>{data.title4}</p>
                <div>
                    <button style={{ color: data.bgColor }} className='bg-white  py-2 px-4 rounded-full'>Compralo ahora!</button>
                </div>
            </div>
        </div>
      </div>
